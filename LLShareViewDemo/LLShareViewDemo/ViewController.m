...
- (void)showShareView {
    ...
    LLShareModel *WXSSModel = [LLShareModel LLShareModelWithindex:0 total:4 Type:LLShareTypeWXSceneSession ButtonTitle:@"微信" ButtonImage:WXSSImage ShareTitle:WXSSTtitle ShareDescription:WXSSStr ShareThumbImage:logo WebpageUrl:@"http://t.cn/RG9cuMF"];
    ...
    LLShareModel *WXSTSModel = [LLShareModel LLShareModelWithindex:1 total:4 Type:LLShareTypeWXSceneTimeline ButtonTitle:@"朋友圈" ButtonImage:WXSTSImage ShareTitle:WXSTTtitle ShareDescription:nil ShareThumbImage:logo WebpageUrl:@"http://t.cn/RG9quf1"];
    ...
    LLShareModel *SMSModel = [LLShareModel LLShareModelWithindex:2 total:4 Type:LLShareTypeSMS ButtonTitle:@"短信" ButtonImage:SMSImage ShareTitle:nil ShareDescription:SMSDes ShareThumbImage:nil WebpageUrl:nil];
